...
public class Server {
    ...
    //    );
        ...
        LessonElement element = new Text(0, "/Users/hellinger/Documents/hopkins/fa19/2019-group-monadic/src/main/resources/lessons/course_0/0.md");
        ...
        // TODO Use relative paths in order to get files to render properly
        element = new Text(0, "/Users/hellinger/Documents/hopkins/fa19/2019-group-monadic/src/main/resources/lessons/course_1/0.md");
        firstLesson = new Lesson(0, new ArrayList<>(), "lesson0");
        firstLesson.addLessonElement(element);

        element = new Text(1, "/Users/hellinger/Documents/hopkins/fa19/2019-group-monadic/2019-group-monadic/src/main/resources/lessons/course_1/2.md");
        secondLesson = new Lesson(1 , new ArrayList<>(), "lesson1");
        secondLesson.addLessonElement(element);

        element = new Text(2, "/Users/hellinger/Documents/hopkins/fa19/2019-group-monadic/src/main/resources/lessons/course_1/2.md");
        var thirdLesson = new Lesson(2, new ArrayList<>(), "lesson2");
        thirdLesson.addLessonElement(element);

        element = new Text(3, "/Users/hellinger/Documents/hopkins/fa19/2019-group-monadic/2019-group-monadic/src/main/resources/lessons/course_1/3.md");
