...
**Problem 1.6.0:** We covered `ret` and `bind`, but what about the other operations we've used: `run`, `raise`, and `tryWith`? Write out their type signatures, and change the old JavaScript code to new TypeScript code.
